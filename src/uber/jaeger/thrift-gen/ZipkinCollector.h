...
class ZipkinCollector_submitZipkinBatch_args {
 public:
  ...
  ZipkinCollector_submitZipkinBatch_args(ZipkinCollector_submitZipkinBatch_args&&);
  ZipkinCollector_submitZipkinBatch_args& operator=(const ZipkinCollector_submitZipkinBatch_args&);
  ZipkinCollector_submitZipkinBatch_args& operator=(ZipkinCollector_submitZipkinBatch_args&&);
...
class ZipkinCollector_submitZipkinBatch_result {
 public:
  ...
  ZipkinCollector_submitZipkinBatch_result(ZipkinCollector_submitZipkinBatch_result&&);
  ZipkinCollector_submitZipkinBatch_result& operator=(const ZipkinCollector_submitZipkinBatch_result&);
  ZipkinCollector_submitZipkinBatch_result& operator=(ZipkinCollector_submitZipkinBatch_result&&);
...
class ZipkinCollectorConcurrentClient : virtual public ZipkinCollectorIf {
 public:
  ZipkinCollectorConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  ZipkinCollectorConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
    setProtocol(iprot,oprot);
  }
 private:
  void setProtocol(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
