...
class Collector_submitBatches_args {
 public:
  ...
  Collector_submitBatches_args(Collector_submitBatches_args&&);
  Collector_submitBatches_args& operator=(const Collector_submitBatches_args&);
  Collector_submitBatches_args& operator=(Collector_submitBatches_args&&);
...
class Collector_submitBatches_result {
 public:
  ...
  Collector_submitBatches_result(Collector_submitBatches_result&&);
  Collector_submitBatches_result& operator=(const Collector_submitBatches_result&);
  Collector_submitBatches_result& operator=(Collector_submitBatches_result&&);
...
class CollectorConcurrentClient : virtual public CollectorIf {
 public:
  CollectorConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  CollectorConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
    setProtocol(iprot,oprot);
  }
 private:
  void setProtocol(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
