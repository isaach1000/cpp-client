...
ValidateTraceResponse::ValidateTraceResponse( ValidateTraceResponse&& other1) {
  ok = std::move(other1.ok);
  traceCount = std::move(other1.traceCount);
}
ValidateTraceResponse& ValidateTraceResponse::operator=(const ValidateTraceResponse& other2) {
  ok = other2.ok;
  traceCount = other2.traceCount;
  return *this;
}
ValidateTraceResponse& ValidateTraceResponse::operator=(ValidateTraceResponse&& other3) {
  ok = std::move(other3.ok);
  traceCount = std::move(other3.traceCount);
  return *this;
}
