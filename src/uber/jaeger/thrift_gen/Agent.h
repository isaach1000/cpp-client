...
class AgentIf {
 public:
  ...
  virtual void emitBatch(const  ::uber::jaeger::thrift::Batch& batch) = 0;
};
...
class AgentNull : virtual public AgentIf {
 public:
  ...
  void emitBatch(const  ::uber::jaeger::thrift::Batch& /* batch */) {
    return;
  }
};
...
class Agent_emitZipkinBatch_args {
 public:
  ...
  Agent_emitZipkinBatch_args(Agent_emitZipkinBatch_args&&);
  Agent_emitZipkinBatch_args& operator=(const Agent_emitZipkinBatch_args&);
  Agent_emitZipkinBatch_args& operator=(Agent_emitZipkinBatch_args&&);
...
class Agent_emitBatch_args {
 public:
  ...
  Agent_emitBatch_args(Agent_emitBatch_args&&);
  Agent_emitBatch_args& operator=(const Agent_emitBatch_args&);
  Agent_emitBatch_args& operator=(Agent_emitBatch_args&&);
  Agent_emitBatch_args() {
  }

  virtual ~Agent_emitBatch_args() throw();
   ::uber::jaeger::thrift::Batch batch;

  _Agent_emitBatch_args__isset __isset;

  void __set_batch(const  ::uber::jaeger::thrift::Batch& val);
...
class Agent_emitBatch_pargs {
 public:
  ...
  const  ::uber::jaeger::thrift::Batch* batch;
...
class AgentClient : virtual public AgentIf {
 ...
 public:
  ...
  void emitBatch(const  ::uber::jaeger::thrift::Batch& batch);
  void send_emitBatch(const  ::uber::jaeger::thrift::Batch& batch);
 protected:
