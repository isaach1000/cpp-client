...
class AggregationValidator_validateTrace_args {
 public:
  ...
  AggregationValidator_validateTrace_args& operator=(AggregationValidator_validateTrace_args&&);
...
class AggregationValidator_validateTrace_result {
 public:
  ...
  AggregationValidator_validateTrace_result& operator=(AggregationValidator_validateTrace_result&&);
...
class AggregationValidatorConcurrentClient : virtual public AggregationValidatorIf {
 public:
  AggregationValidatorConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  AggregationValidatorConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
    setProtocol(iprot,oprot);
  }
 private:
  void setProtocol(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
