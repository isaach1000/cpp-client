...
class SamplingManager_getSamplingStrategy_args {
 public:
  ...
  SamplingManager_getSamplingStrategy_args(SamplingManager_getSamplingStrategy_args&&);
  SamplingManager_getSamplingStrategy_args& operator=(const SamplingManager_getSamplingStrategy_args&);
  SamplingManager_getSamplingStrategy_args& operator=(SamplingManager_getSamplingStrategy_args&&);
...
class SamplingManager_getSamplingStrategy_result {
 public:
  ...
  SamplingManager_getSamplingStrategy_result(SamplingManager_getSamplingStrategy_result&&);
  SamplingManager_getSamplingStrategy_result& operator=(const SamplingManager_getSamplingStrategy_result&);
  SamplingManager_getSamplingStrategy_result& operator=(SamplingManager_getSamplingStrategy_result&&);
...
class SamplingManagerConcurrentClient : virtual public SamplingManagerIf {
 public:
  SamplingManagerConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  SamplingManagerConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
    setProtocol(iprot,oprot);
  }
 private:
  void setProtocol(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
