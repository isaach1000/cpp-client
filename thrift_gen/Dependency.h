...
class Dependency_getDependenciesForTrace_args {
 public:
  ...
  Dependency_getDependenciesForTrace_args(Dependency_getDependenciesForTrace_args&&);
  Dependency_getDependenciesForTrace_args& operator=(const Dependency_getDependenciesForTrace_args&);
  Dependency_getDependenciesForTrace_args& operator=(Dependency_getDependenciesForTrace_args&&);
...
class Dependency_getDependenciesForTrace_result {
 public:
  ...
  Dependency_getDependenciesForTrace_result(Dependency_getDependenciesForTrace_result&&);
  Dependency_getDependenciesForTrace_result& operator=(const Dependency_getDependenciesForTrace_result&);
  Dependency_getDependenciesForTrace_result& operator=(Dependency_getDependenciesForTrace_result&&);
...
class Dependency_saveDependencies_args {
 public:
  ...
  Dependency_saveDependencies_args(Dependency_saveDependencies_args&&);
  Dependency_saveDependencies_args& operator=(const Dependency_saveDependencies_args&);
  Dependency_saveDependencies_args& operator=(Dependency_saveDependencies_args&&);
...
class DependencyConcurrentClient : virtual public DependencyIf {
 public:
  DependencyConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  DependencyConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
    setProtocol(iprot,oprot);
  }
 private:
  void setProtocol(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
