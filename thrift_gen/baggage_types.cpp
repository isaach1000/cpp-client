...
BaggageRestriction::BaggageRestriction( BaggageRestriction&& other1) {
  baggageKey = std::move(other1.baggageKey);
  maxValueLength = std::move(other1.maxValueLength);
}
BaggageRestriction& BaggageRestriction::operator=(const BaggageRestriction& other2) {
  baggageKey = other2.baggageKey;
  maxValueLength = other2.maxValueLength;
  return *this;
}
BaggageRestriction& BaggageRestriction::operator=(BaggageRestriction&& other3) {
  baggageKey = std::move(other3.baggageKey);
  maxValueLength = std::move(other3.maxValueLength);
  return *this;
}
