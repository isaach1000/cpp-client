...
class DependencyLink : public virtual ::apache::thrift::TBase {
 public:
  ...
  DependencyLink& operator=(DependencyLink&&);
...
inline std::ostream& operator<<(std::ostream& out, const DependencyLink& obj)
{
  obj.printTo(out);
  return out;
}
...
inline std::ostream& operator<<(std::ostream& out, const Dependencies& obj)
{
  obj.printTo(out);
  return out;
}
